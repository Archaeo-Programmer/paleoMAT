...
site.preds.sf <- st_as_sf(site.preds, coords = c("long", "lat"), crs = 4326) %>% 
...
proj4string(grd_template_raster) <- CRS("+proj=utm +zone=10+datum=WGS84")
