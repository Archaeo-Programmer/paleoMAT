...
temp.raster <- raster::mask(modern_temp, bbox_buffer)
...
#ok <- tavg_100yrs[1:2,]
ok <- tavg_100yrs$site.predictions[[18]]



temperature = as.data.frame(extract(modern_temp, ok)) %>% 
  dplyr::rename(modern = 1)
ok <- cbind(ok, temperature)
