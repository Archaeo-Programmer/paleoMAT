...
# ggsave("vignettes/figures/Figure1.png", dpi = 600)
...
#ggsave("vignettes/figures/Figure2.png", dpi = 600)
...
#ggsave("vignettes/figures/Figure3.png", dpi = 600)
...
#ggsave("vignettes/figures/Figure4.png", dpi = 600)
...
#ggsave("vignettes/figures/Figure5.png", dpi = 600)
...
#ggsave("vignettes/figures/Figure6.png", dpi = 600)
...
#ggsave("vignettes/figures/Figure7.png", dpi = 600)
...
rlen_results_filtered <-
  readr::read_rds(here::here("./vignettes/data/rlen_full_results2.rds"))$res_lengths %>%
  left_join(., ff, by = "sample.id")

ninety5quant <-
  readr::read_rds(here::here("./vignettes/data/rlen_full_results2.rds"))$quantile_95
...
#ggsave("vignettes/figures/SuppFigure1.png", dpi = 600)
...
#ggsave("vignettes/figures/SuppFigure2.png", dpi = 600)
...
minDC_df <-
  readr::read_rds(here::here("./vignettes/data/minDC_full_results.rds"))$minDC %>%
  arrange(age)

# Keeping only 1%, 2.5%, and 5%, as I don't want to plot 10%.
minDC_quantiles <-
  readr::read_rds(here::here("./vignettes/data/minDC_full_results.rds"))$quantiles[1:3]
...
#ggsave("vignettes/figures/SuppFigure3.png", dpi = 600)
...
#ggsave("vignettes/figures/SuppFigure4.png", dpi = 600)
...
#ggsave("vignettes/figures/SuppFigure5.png", dpi = 600)
