...
UUSS_sites <- subset(NAfossil_metadata_counts, long > extent.FourCorners@xmin & long < extent.FourCorners@xmax)
UUSS_sites <- subset(UUSS_sites3, lat >= extent.FourCorners@ymin & lat <= extent.FourCorners@ymax)
