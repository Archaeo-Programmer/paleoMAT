...
# Plot the warmest month, July.
UUSS_100yrAvgs_July_plot <- ggplot(data=(dplyr::filter(UUSS_100yrAvgs_July)), aes(x=midP, y=reconst_mean, color = reconst_mean)) +
      geom_line() +
      geom_ribbon(aes(x=midP, ymin = reconst_mean - err_mean,
                      ymax = reconst_mean + err_mean,
                      alpha = 0.2),
    ...
    # Save the plot for one month.
    ggsave(UUSS_100yrAvgs_July_plot, file = "UUSS_100yrAvgs_July_plot.tiff", path = "./output/UUSS/")
...
visreg(GDD_fit, xlab = "Elevation (m)", ylab = "Growing Degree Days")
summary(GDD_fit)
