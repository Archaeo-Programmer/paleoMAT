...
temp_UUSS_100yrAvgs_7analog_GS[2,7] <- 0
temp_UUSS_100yrAvgs_7analog_GS[21,7] <- 2000

UUSS_100yrAvgs_7analog_GS_plot <- ggplot(data=(dplyr::filter(temp_UUSS_100yrAvgs_7analog_GS[2:21, ])), aes(x=midP, y=reconst_mean, label = reconst_n, label2 = reconst_unique_sites)) + 
...
UUSS_100yrAvgs_7analog_July_plot <- ggplot(data=(dplyr::filter(temp_UUSS_100yrAvgs_7analog_July[2:21, ])), aes(x=midP, y=reconst_mean, label = reconst_n, label2 = reconst_unique_sites)) +
      #scale_color_gradient(low="blue", high="red") +
      geom_ribbon(aes(x=midP, ymin = reconst_mean - err_mean,
                      ymax = reconst_mean + err_mean,
                      alpha = 0.2),
...
UUSS_100yrAvgs_GDD_7analog <- UUSS_100yrAvgs_GDD_7analog %>% 
  dplyr::mutate(residuals = GDD_fit_7analog$residuals)

# Plot GDD
temp_UUSS_100yrAvgs_GDD_7analog <- UUSS_100yrAvgs_GDD_7analog
temp_UUSS_100yrAvgs_GDD_7analog[2,7] <- 0
temp_UUSS_100yrAvgs_GDD_7analog[21,7] <- 2000

UUSS_100yrAvgs_GDD_7analog_Residuals_plot <- ggplot(data=(dplyr::filter(temp_UUSS_100yrAvgs_GDD_7analog[2:21, ])), aes(x=midP, y=residuals)) +
...
raster::plot(temprast14, col=colors, useRaster=T, legend=F, legend.shrink=0.25, xlab="", ylab="", add=T, zlim=c(0,35))
...
temp_UUSS_100yrAvgs_GDD_7analog_anomaly[2,7] <- 0
...
UUSS_100yrAvgs_GDD_7analog_anomaly_plot <- ggplot(data=(dplyr::filter(temp_UUSS_100yrAvgs_GDD_7analog_anomaly[2:21, ])), aes(x=midP, y=anomaly_mean, label = reconst_n, label2 = reconst_unique_sites)) +
    ...
    # Save the plot for GS.
    ggsave(UUSS_100yrAvgs_GDD_7analog_anomaly_plot, file = "UUSS_100yrAvgs_GDD_7analog_anomaly_plot.tiff", path = "./output/UUSS/analog_7/", units="in", width=21, height=13, dpi=600, compression = 'lzw')
