...
saveRDS(tavg_preds, file = "/Users/andrew/Dropbox/WSU/SKOPEII/Figures/temp_rasters.RDS")
# Rename the layers.
...
tavg_rbrick <- raster::brick(ok, varname = "anom")
...
plot(tavg_rbrick, nc=6, maxnl=32, col =colors)
...
anim <- tm_shape(tavg_rstack2) + tm_raster(palette = colors, title = "Temperature Anamoly", breaks = c(-9999, seq(-4.0, 4.0, 0.5), 9999 )) + tm_facets(nrow = 1, ncol = 1)
tmap_animation(anim, "/Users/andrew/Dropbox/WSU/SKOPEII/Figures/temp_rasters.gif")
