...
if (!file.exists(here::here(
  ...
  # Read in the United States shapefile, which will be used to filter out modern pollen sites that are outside of the continental United States.
  states <-
    rgdal::readOGR("vignettes/data/spatial/statesp010g/statesp010g.shp",
                   layer = 'statesp010g')
...
if (!file.exists(here::here("vignettes/data/spatial/west_in_states.shp"))) {
  west_in_states <- paleomat::extract_WS_pollen_ranges()
}
west_in_states <-
  sf::read_sf("vignettes/data/spatial/west_in_states.shp")
...
fossil_west_post5500 <-
  readr::read_rds(here::here("vignettes/data/pollen_cleaned/fossil_west_post5500.rds"))
...
MPCT_proportions <-
  readr::read_rds(here::here("vignettes/data/pollen_cleaned/MPCT_proportions.rds"))
...
fossil_pollen <-
  readr::read_rds(here::here("vignettes/data/pollen_cleaned/fossil_pollen.rds"))
...
```{r squared_residual_length, cache=TRUE, results='asis', echo=FALSE, warning=FALSE}
...
```{r anomaly_calculation, cache=TRUE, results='asis', echo=FALSE, warning=FALSE}

# Get the PRISM modern July temperature dataset.
temp.raster <-
  raster::raster("./vignettes/data/spatial/temp.raster.tif")
