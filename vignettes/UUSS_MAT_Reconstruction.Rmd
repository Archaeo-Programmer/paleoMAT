...
### Generalized Additive Model (GAM) and Mapping
...
tavg_preds <- tavg_100yrs %>% 
  dplyr::mutate(raster.preds = purrr::map(site.predictions, map_predictions(prism.raster = UUSS_prism, preds.extent = fossilpolygon)))
