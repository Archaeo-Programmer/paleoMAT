...
if (!file.exists(here::here("vignettes/data/pollen_downloads/NAfossil_metadata_counts.rds"))) {
  NAfossil_metadata_counts <-
    ...
    readr::write_rds(here::here("vignettes/data/pollen_downloads/NAfossil_metadata_counts.rds"))
}
NAfossil_metadata_counts <-
  readr::read_rds(here::here("vignettes/data/pollen_downloads/NAfossil_metadata_counts.rds"))
...
if (!file.exists(here::here("vignettes/data/pollen_cleaned/MPCT_metadata_counts_final.rds"))) {
...
if (!file.exists(here::here("vignettes/data/spatial/west_in_states.shp"))) {
  ...
  temp <-
    list.files(path = "vignettes/data/spatial/Williams and Shuman 2008 Supplementary",
               pattern = "*WEST.shp$",
               full.names = TRUE)
  ...
  names(myfiles) <- gsub(
    ...
    "",
    list.files(
      "vignettes/data/spatial/Williams and Shuman 2008 Supplementary",
      pattern = "*WEST.shp$",
      full.names = FALSE
    ),
    fixed = TRUE
...
if (!file.exists(here::here("vignettes/data/pollen_cleaned/fossil_metadata_counts_final2.rds"))) {
...
if (!file.exists(here::here("vignettes/data/pollen_cleaned/fossil_final_west_metadata_post5500BP.rds"))) {
  ...
  readr::write_rds(
    fossil_final_west_metadata_post5500BP,
    here::here("vignettes/data/pollen_cleaned/fossil_final_west_metadata_post5500BP.rds")
  )
}
fossil_final_west_metadata_post5500BP <-
  readr::read_rds(here::here("vignettes/data/pollen_cleaned/fossil_final_west_metadata_post5500BP.rds"))
...
if (!file.exists(here::here("vignettes/data/pollen_cleaned/fossil_pollen.rds"))) {
  ...
  readr::write_rds(fossil_pollen,
                   here::here("vignettes/data/pollen_cleaned/fossil_pollen.rds"))
}
fossil_pollen <-
...
if (!file.exists(here::here("vignettes/data/rlen_results.rds"))) {
  rlen_results <-
    purrr::map(
  ...
  readr::write_rds(rlen_results,
                   here::here("vignettes/data/rlen_results.rds"))
}
rlen_results <-
  readr::read_rds(here::here("vignettes/data/rlen_results.rds")
  )
...
rlen_full_results1 <- rlen_results %>%
  ...
  dplyr::filter(sample.id %in% fossil_final_west_metadata_post5500BP$sample.id)
...
if (!file.exists(here::here("vignettes/data/mat_prediction.rds"))) {
  # Create the transfer function using mat from the analogue package.
  rlgh.mat2 <- analogue:::predict.mat(object = swap.mat2, newdata = fossil_input, k = 4)
...
if (!file.exists(here::here("vignettes/data/mat_prediction_bootstrap.rds"))) {
  # Create the transfer function using mat from the analogue package.
  rlgh.mat2b4 <- analogue:::predict.mat(object = swap.mat2, newdata = fossil_input, k = 4, bootstrap = TRUE)
