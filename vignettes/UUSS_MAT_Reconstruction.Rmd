...
if(!file.exists(here::here("vignettes/data/CT_metadata_counts.rds"))) {
  CT_metadata_counts <-
...
if (!file.exists(here::here("vignettes/data/fossil_final.rds"))) {
  fossil_final <-
    fossil_metadata_counts_final2 %>%
  ...
  readr::write_rds(fossil_final,
                   here::here("vignettes/data/fossil_final.rds"))
}
fossil_final <-
  readr::read_rds(here::here("vignettes/data/fossil_final.rds"))
