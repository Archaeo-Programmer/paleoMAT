...
west_in_states <- sf::st_intersection(all_west, st_union(continental.states))
west_in_states_spdf <- sf:::as_Spatial(west_in_states)

write_sf(west_in_states, dsn = "vignettes/data/raw_data/", layer = 'west_in_states', driver = "ESRI Shapefile")
read_sf("vignettes/data/raw_data/west_in_states.shp")
