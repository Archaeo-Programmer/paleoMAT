...
# Now, we carry out the reconstruction for all fossil pollen sites in the continental United States. The reconstructions are in one output file, which has the reconstructed tavg and associated error.
