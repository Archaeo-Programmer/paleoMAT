...
names(tavg_rbrick) <- c("1000 BC","900 BC","800 BC", "700 BC", "600 BC","500 BC", "400 BC", "300 BC", "200 BC", "100 BC", "AD 1", "AD 100", "AD 200", "AD 300", "AD 400", "AD 500", "AD 600", "AD 700", "AD 800","AD 900", "AD 1000", "AD 1100", "AD 1200", "AD 1300", "AD 1400", "AD 1500", "AD 1600", "AD 1700", "AD 1800")
dt<-as.data.frame(
...
#Get the elevation dataset. Also, reprojecting at a lower resolution, so that things will run faster.
NED <-
  raster::raster("/Volumes/DATA/NED/EXTRACTIONS/SKOPE_SWUS/rasters/NED_1.tif")
NED <- raster::aggregate(NED, fact = 4)
NED <-
...
NED.lat <- raster::yFromRow(NED)[2:962]
...
fit.full<- predictSurface(fit_TPS, grid.list, ZGrid=NED.list)
