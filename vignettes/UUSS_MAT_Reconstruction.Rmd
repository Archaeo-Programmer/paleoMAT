...
if (!file.exists(here::here("vignettes/data/fossil_final_west_metadata.rds"))) {
  readr::write_rds(
    fossil_final_west_metadata_post5500BP,
    here::here("vignettes/data/fossil_final_west_metadata.rds")
  )
}
fossil_final_west_metadata_post5500BP <-
...
#readr::write_rds(rlgh.mat2b4, here::here("vignettes/data/predict_mat_ouput.rds"))
