...
names(tavg_recon_list) <- c("BC950","BC850","BC750", "BC650", "BC550","BC450", "BC350", "BC250", "BC150", "BC50", "AD50", "AD150", "AD250", "AD350", "AD450", "AD550", "AD650", "AD750", "AD850","AD950", "AD1050", "AD1150", "AD1250", "AD1350", "AD1450", "AD1550", "AD1650", "AD1750")

anomaly_plots <-
  purrr::map2(
    .x = tavg_recon_list, .y = names(tavg_recon_list),
    .f = 
...
# Save as one pdf. Use scale here in order for the multi-plots to fit on each page.
ggsave("/Users/andrewgillreath-brown/Dropbox/WSU/SKOPEII/Figures/anomaly_plots_arranged.pdf", anomaly_plots_arranged, scale = 1.5, 
       width = 210, 
       height = 297, 
       units = "mm")
