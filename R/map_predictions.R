map_predictions <-
  function(site.preds, prism.raster, preds.extent) {
    ...
    # However, this can be circumvented by assigning a k value for those less than 30. Here, the total number of sites is used when the
    # number of sites is less than 30. If equal to or greater than 30, then the model runs with the default settings.
