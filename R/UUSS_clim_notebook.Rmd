...
NAID <-  gpids %>%
  dplyr::filter(GeoPoliticalName %in% c('United States'),
...
# Get the modern pollen datasets in North America and use lapply to apply the compile function to simply return a list of the metadata of each sample.
