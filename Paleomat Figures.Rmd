...
```{r fig4, fig.cap="Low-frequency temperature reconstruction time series from this study of the UUSS.", fig.width=10.5, echo=FALSE,warning=FALSE,message=FALSE,error=FALSE, results='hide',fig.keep='all'}
...
```{r fig5, fig.cap="Low-frequency temperature reconstruction spatial interpolation for this study of the UUSS.", fig.width=10.5, echo=FALSE,warning=FALSE,message=FALSE,error=FALSE, results='hide',fig.keep='all'}
