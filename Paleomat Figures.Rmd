...
kaufman_standard <- read.csv("./vignettes/data/external_datasets/Kaufman 2020_Figure6Data.csv") %>% 
...
if (!file.exists(here::here("./vignettes/figures/table1.csv"))) {
  write.csv(table1,
            "./vignettes/figures/table1.csv",
            row.names = FALSE)
}
...
if (!file.exists(here::here("./vignettes/figures/supp_table_s1.csv"))) {
  write.csv(summary_table_final,
            "./vignettes/figures/supp_table_s1.csv",
            row.names = FALSE)
}
...
ff <- readr::read_rds(here::here("./vignettes/data/pollen_cleaned/fossil_final_west_metadata_post5500BP.rds")) %>% 
