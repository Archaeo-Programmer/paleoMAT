...
site.preds.unlisted.anom %>% 
  ...
  geom_line(aes(x = date, y = temp), colour = "red", size = 1.0) +
  #geom_point() +
  xlab("Year BC/AD") +
  ...
  #                   limits = c(10, 18)) +
  scale_x_continuous(breaks = seq(-3200, 2000, 300),
                     minor_breaks = seq(-3100, 1900, 300),
                     limits = c(-3000, 2000)) +
...
ggsave("new_anom2.png", width = 13.3, height = 7.5, units = "in", dpi = 600)
