...
ggsave("~/Dropbox/WSU/SKOPEII/model/Final_Figures/Figure5.png", dpi = 600)
...
ggsave("~/Dropbox/WSU/SKOPEII/model/Final_Figures/Figure6_diff.png", dpi = 600)
...
viau <- read.csv("~/Dropbox/WSU/SKOPEII/model/viau.csv") %>% 
...
viau_paleomat <- bind_rows(temp_anom_standard, viau_standard, Moberg_standard)
...
viau_paleomat %>% 
  ...
  # geom_vline(xintercept = c(1002, 1144, 1225, 1286, 1447, 1582), color = "red", linetype="twodash", lwd = 0.5) +
  geom_line(size = 2.0) +
  scale_color_manual(values=c("cornflowerblue", "darkolivegreen")) +
  #scale_color_manual(values=c("#A60F2D", "cornflowerblue", "darkolivegreen")) +
  xlab("Years AD") +
  ylab("Standardized Temperature Values (Z-Scores)") +
  scale_x_continuous(
                     breaks = seq(-3000, 2000, 500), 
                     minor_breaks=seq(-2900,1900,by=100),
                     guide = "axis_minor") +
...
ggsave("~/Dropbox/WSU/SKOPEII/model/Final_Figures/viau_mat_15span.png", dpi = 600)
